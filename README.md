...
single-seed top-k is prohibited. Recorded HR, blood pressure, SpO2, ETCO2, SQI,
respiratory variables, and HRV may support prediction analyses but cannot enter the
counterfactual RL observation unless action-conditioned transitions are validated.
...
- `all_supported`: all observable variables generated by the current simulator.
