"""Run validation-only explicit feature attention on the canonical universe."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    """Parse the locked main-rerun attention configuration."""
...
def main() -> None:
    ...
    output_dir = args.output_dir or Path(
        "outputs/simulator_compatible_prediction_v2/attention"
    ) / run_name
    ...
    write_main_run_context(
        output_dir, model_name="factorized_attention_gru", dataset_metadata=metadata
    )
